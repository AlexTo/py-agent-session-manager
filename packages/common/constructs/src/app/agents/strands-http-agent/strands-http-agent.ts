...
export type StrandsHttpAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
  ...
  implements IGrantable, IConnectable
{
  ...
  constructor(scope: Construct, id: string, props?: StrandsHttpAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/strands_agents/docker/strands-http-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'StrandsHttpAgent', {
    ...
    rc.set('connection', 'agentRuntimes', {
      ...
      StrandsHttpAgent: this.agentCoreRuntime.agentRuntimeArn,
    });
  }
