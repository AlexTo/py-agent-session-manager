...
export type StrandsAguiAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
  ...
  implements IGrantable, IConnectable
{
  ...
  constructor(scope: Construct, id: string, props?: StrandsAguiAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/strands_agents/docker/strands-agui-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'StrandsAguiAgent', {
    ...
    rc.set('connection', 'agentRuntimes', {
      ...
      StrandsAguiAgent: this.agentCoreRuntime.agentRuntimeArn,
    });
  }
