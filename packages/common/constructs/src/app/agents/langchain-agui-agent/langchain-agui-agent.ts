...
export type LangchainAguiAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class LangchainAguiAgent
  extends Construct
  implements IGrantable, IConnectable
{
  ...
  constructor(scope: Construct, id: string, props?: LangchainAguiAgentProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/langchain_agents/docker/langchain-agui-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'LangchainAguiAgent', {
    ...
    rc.set('connection', 'agentRuntimes', {
      ...
      LangchainAguiAgent: this.agentCoreRuntime.agentRuntimeArn,
    });
  }
