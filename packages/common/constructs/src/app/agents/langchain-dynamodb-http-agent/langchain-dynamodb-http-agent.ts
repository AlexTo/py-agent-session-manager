...
export type LangchainDynamodbHttpAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class LangchainDynamodbHttpAgent
  extends Construct
  implements IGrantable, IConnectable
{
  ...
  public readonly agentName = 'langchain-dynamodb-http-agent';
  ...
  constructor(
    scope: Construct,
    id: string,
    props?: LangchainDynamodbHttpAgentProps,
  ) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/langchain_dynamodb_agents/docker/langchain-dynamodb-http-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'LangchainDynamodbHttpAgent', {
