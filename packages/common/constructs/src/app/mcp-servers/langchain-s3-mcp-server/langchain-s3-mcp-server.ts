...
export type LangchainS3McpServerProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class LangchainS3McpServer
  extends Construct
  implements IGrantable, IConnectable
{
  ...
  public readonly mcpServerName = 'langchain-s3-mcp-server';

  constructor(scope: Construct, id: string, props?: LangchainS3McpServerProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/langchain_s3_agents/docker/langchain-s3-mcp-server',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'LangchainS3McpServer', {
