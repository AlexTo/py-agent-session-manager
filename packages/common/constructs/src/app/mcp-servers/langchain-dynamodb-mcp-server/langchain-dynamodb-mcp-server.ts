...
export type LangchainDynamodbMcpServerProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class LangchainDynamodbMcpServer
  extends Construct
  implements IGrantable, IConnectable
{
  ...
  public readonly mcpServerName = 'langchain-dynamodb-mcp-server';

  constructor(
    scope: Construct,
    id: string,
    props?: LangchainDynamodbMcpServerProps,
  ) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/langchain_dynamodb_agents/docker/langchain-dynamodb-mcp-server',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'LangchainDynamodbMcpServer', {
