...
export type LangchainAgentsMcpServerProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class LangchainAgentsMcpServer
  extends Construct
  implements IGrantable, IConnectable
{
  ...
  public readonly mcpServerName = 'langchain-agents-mcp-server';

  constructor(
    scope: Construct,
    id: string,
    props?: LangchainAgentsMcpServerProps,
  ) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/langchain_agents/docker/langchain-agents-mcp-server',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'LangchainAgentsMcpServer', {
