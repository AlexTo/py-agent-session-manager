...
export const useAguiLangchainAguiAgent = (): Record<string, AbstractAgent> => {
  const runtimeConfig = useRuntimeConfig();
  const agentRuntimeValue = runtimeConfig.agentRuntimes.LangchainAguiAgent;
  ...
  return useMemo((): Record<string, AbstractAgent> => {
    ...
    return { 'langchain-agui-agent': agent };
  }, [url, sigv4]);
};
