...
export const useAguiStrandsAguiAgent = (): Record<string, AbstractAgent> => {
  const runtimeConfig = useRuntimeConfig();
  const agentRuntimeValue = runtimeConfig.agentRuntimes.StrandsAguiAgent;
  ...
  return useMemo((): Record<string, AbstractAgent> => {
    ...
    return { 'strands-agui-agent': agent };
  }, [url, sigv4]);
};
